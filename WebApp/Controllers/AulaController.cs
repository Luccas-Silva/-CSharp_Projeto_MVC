...
namespace WebApp.Controllers
{
    public class AulaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Materia,Turma")] AulaModel aulaModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Materia,Turma")] AulaModel aulaModel)
        {
            if (id != aulaModel.Id)
            {
                return NotFound();
